...
This document analyse the relationship between every diseases in the [UKBiobank](http://www.ukbiobank.ac.uk/data-showcase/) dataset. What it does:  

  
* Load the comorbidity matrix  
* Calculate Comorbidity Index (CI) for each level  
* Visualize it  
...
##Como matrix {.tabset .tabset-fade .tabset-pills}
The como matrices have been calculated previously (script data_wrangling).  
...
#Hierarchical Edge Bundling all groups
