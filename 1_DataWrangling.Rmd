...
This file is the first part of the UK Biobank comorbidity analysis. It does:  

* Take a few columns in the whole phenotypic file of the UKB  
* Takes the ICD10 classification of disease and transform it in a workable format  
* Explain how HES data were harvested and treated  
* I calculate the Comorbidty matrix: gives the occurence of each disease and each pair of disease  
...
Three version of this count table are thus provided and available on github: at level1, level2 and level3. 
...
```{r}
Herit=read.table("0_DATA/ukbb_all_h2part_results.txt", sep="\t", header = T)
